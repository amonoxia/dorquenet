...
namespace Drupal\synonyms_autocomplete\Element;
...
class SynonymsEntityAutocomplete extends Textfield {
  ...
  public static function validateEntityAutocomplete(array &$element, FormStateInterface $form_state, array &$complete_form) {
    ...
    foreach ($tokens as $token) {
      ...
      if (!$entity_id) {
        $lookup = \Drupal::service('synonyms.behavior.autocomplete')->autocompleteLookup($token, $element['#autocomplete_route_parameters']['token']);
