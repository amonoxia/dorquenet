 ...
 *
 * @FieldFormatter(
 *   id = "rgp_url_800x450_formatter",
 *   label = @Translation("Remote Google Photos 800x450"),
 *   description = @Translation("Display the remote Google photos in wide size (800x450)"),
 *   field_types = {
 *     "rgp_url"
 *   }
 * )
 */
class RemoteGooglePhotosUrl800X450Formatter extends LinkFormatter
{
