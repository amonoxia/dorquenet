 ...
 *
 * @FieldFormatter(
 *   id = "rgp_url_500x300_formatter",
 *   label = @Translation("Remote Google Photos 500x300"),
 *   description = @Translation("Display the remote Google photos in wide size (500x300)"),
 *   field_types = {
 *     "rgp_url"
 *   }
 * )
 */
class RemoteGooglePhotosUrl500X300Formatter extends LinkFormatter
{
