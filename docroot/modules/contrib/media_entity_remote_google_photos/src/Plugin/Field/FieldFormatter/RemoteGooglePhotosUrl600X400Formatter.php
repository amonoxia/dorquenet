 ...
 *
 * @FieldFormatter(
 *   id = "rgp_url_700x500_formatter",
 *   label = @Translation("Remote Google Photos 700x500"),
 *   description = @Translation("Display the remote Google photos in wide size (700x500)"),
 *   field_types = {
 *     "rgp_url"
 *   }
 * )
 */
class RemoteGooglePhotosUrl600X400Formatter extends LinkFormatter
{
